...
__export(src_exports, {
  ...
  DEFAULT: () => DEFAULT,
  DELETE: () => DELETE,
  DependancyManager: () => DependancyManager,
  EXPRESS_CONTEXT_NAME: () => EXPRESS_CONTEXT_NAME,
  ExpressApplication: () => ExpressApplication,
  ExpressApplicationContext: () => ExpressApplicationContext,
  ExpressApplicationManager: () => ExpressApplicationManager,
  ExpressIdBuilder: () => ExpressIdBuilder,
  ExpressIdType: () => ExpressIdType,
  ExpressRequestParam: () => ExpressRequestParam,
  ExpressRouteHandlerManager: () => ExpressRouteHandlerManager,
  GET: () => GET,
  HTTPRequestParamUtil: () => HTTPRequestParamUtil,
  HTTPRouteHandlerModel: () => HTTPRouteHandlerModel,
  HTTPRouteHandlerParameter: () => HTTPRouteHandlerParameter,
  HTTPRouteModel: () => HTTPRouteModel,
  HttpMethod: () => HttpMethod,
  HttpStatusCode: () => HttpStatusCode,
  IDBuilder: () => IDBuilder,
  IDUtil: () => IDUtil,
  IOCContainerRepository: () => IOCContainerRepository,
  IOCContext: () => IOCContext,
  IOCContextDecorator: () => IOCContextDecorator,
  ...
  RouteControllerManager: () => RouteControllerManager,
  RouteHandlerManager: () => RouteHandlerManager,
  SOCKETIO_CONTEXT_NAME: () => SOCKETIO_CONTEXT_NAME,
  SOCKET_TAG: () => SOCKET_TAG,
  Service: () => Service,
  SocketController: () => SocketController,
  SocketEvent: () => SocketEvent,
  SocketIOApplication: () => SocketIOApplication,
  SocketIOApplicationContext: () => SocketIOApplicationContext,
  SocketIOApplicationManager: () => SocketIOApplicationManager,
  SocketIORouteHandlerManager: () => SocketIORouteHandlerManager,
  SocketRequestParam: () => SocketRequestParam,
...
var ExpressApplicationManager = class {
  ...
  createServer(preconfig) {
    ...
    this.app.use((0, import_cors.default)(this.serverOptions.cors));
...
var SocketIOApplicationManager = class {
  ...
  createServer(preconfig) {
    ...
    this.io = new import_socket.Server(this.httpServer, this.serverOptions);
